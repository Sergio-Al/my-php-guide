...
// defining the error handler, which will translate errors to exceptions
// and forward these to the exception handler.
...
// run:
    //> php factorial.php
    //> php factorial.php 1 2 3 20 21 -1 4.2 4th four