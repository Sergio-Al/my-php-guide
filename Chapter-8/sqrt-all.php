...
if (is_float($input * 1)) {
    ...
    trigger_error(
        sprintf(
            'Decimal numbers are not allowed for this operation. will use rounded integer value [%d].',
            $input
        ),
        E_USER_WARNING
    );
...
// Remember E_USER_ERROR 256 brings the script to halt 
//          E_USER_WARNING 512 allows the script to continue